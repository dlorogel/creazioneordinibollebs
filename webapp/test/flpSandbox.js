		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Crezione Ordini Bolle BS",
									"targetURL": "#itorogelcrezioneordinibollebs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelcrezioneordinibollebs-display": {
								"semanticObject": "itorogelcrezioneordinibollebs",
								"action": "display",
								"description": "Crezione Ordini Bolle BS",
								"title": "Crezione Ordini Bolle BS",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.crezioneordinibollebs",
									"url": sap.ui.require.toUrl("it/orogel/crezioneordinibollebs")
								}
							}
						}
					}
